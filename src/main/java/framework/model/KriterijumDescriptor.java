...
public record KriterijumDescriptor(boolean negate, Class<? extends Entitet> target, String imePolja, String op, Object vrednost) implements Serializable {
    ...
    public static PreparedStatement procesirajKriterijume(Connection con, String joinString, List<KriterijumDescriptor> deskriptori, AppConfig cfg) throws SQLException {
            ...
            try {
                ...
                if (!kd.op().equals("IN")) {
                    ...
                    if (!f.getType().equals(kd.vrednost().getClass())) {
                        SimpleLogger.log(LogLevel.LOG_ERROR, "Tip vrednosti prosledjenog kriterijuma se ne poklapa sa pravom vrednoscu polja, abortiram");
                        return null;
                    }
